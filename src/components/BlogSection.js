...
import BannerMatrixRainfallReact from "../assets/gifs/Banner_MatrixRainfallReact.gif";
import BannerGlitchingTypingAnimation from "../assets/gifs/Banner_GlitchingTypingAnimation.gif";
	...
	return (
		<Subsection ref={ref}>
			...
			<DetailLine style={{ opacity: elementVisibility.bannerImage ? 1 : 0, justifyContent: "center" }}>
				<DetailBannerImage src={bannerImage.src} alt={bannerImage.alt} />
			</DetailLine>
		</Subsection>
	);
};
...
const posts = [
	{
		...
		bannerImage: { src: BannerGlitchingTypingAnimation, alt: "A banner gif for the tutorial" },
	},
	{
		...
		bannerImage: { src: BannerMatrixRainfallReact, alt: "A banner gif for the tutorial" },
	},
];
