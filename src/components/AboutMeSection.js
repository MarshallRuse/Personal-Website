                    ...
                    >
                        ...
                        {tabSelected === 0 ? (
                            <>
                                <FadeDownText>
                                    <p>
                                        <strong>09-2012 - 04-2016</strong> Queen's University - Kingston, Ontario
                                    </p>
                                    <p style={{ fontWeight: 100, marginLeft: "2em", marginBottom: "2em" }}>
                                        Bachelor of Sciences, Honours - Life Science
                                    </p>
                                </FadeDownText>
                                <FadeDownText>
                                    <p>
                                        <strong>09-2016 - 04-2019</strong> Queen's University - Kingston, Ontario
                                    </p>
                                    <p style={{ fontWeight: 100, marginLeft: "2em", marginBottom: "2em" }}>
