...
import SnazzyStockPage from "../components/SnazzyStockPage";
import RotationCoordinatorReportFormatterPage from "../components/RotationCoordinatorReportFormatterPage";
    ...
    return (
        <BrowserRouter>
            ...
            <Switch>
                ...
                <Route path='/projects/SnazzyStock' component={SnazzyStockPage} exact />
                <Route
                    path='/projects/RotationCoordinatorReportFormatter'
                    component={RotationCoordinatorReportFormatterPage}
                    exact
                />
